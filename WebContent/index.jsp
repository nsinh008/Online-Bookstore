		...
		<div class="container">
		  ...
		  <div class="nav-collapse">
			<ul class="nav">
			  ...
			  <li hidden class=""><a href="list-view.html">List View</a></li>
			  <li hidden class=""><a href="grid-view.html">Grid View</a></li>
			  <li hidden class=""><a href="three-col.html">Three Column</a></li>
			  <li hidden class=""><a href="four-col.html">Four Column</a></li>
			  <li hidden class=""><a href="general.html">General Content</a></li>
			</ul>
...
<div class="well well-small">
	...
	-->
		<div class="well well-small">
		  ...
		  <hr class="soften"/>
		  <div class="row-fluid">
		   <c:forEach items="${booklist}" var="book" varStatus="bookNum">
		  <ul class="thumbnails">
			<li class="span4">
			  <div class="thumbnail">
				<a class="zoomTool" href="/OnlineBookStore/ProductInfoServlet?bookid=${book.bookid}" title="add to cart"><span class="icon-search"></span> QUICK VIEW</a>
				<a  href="product_details.html"><img src="${book.image}" alt="${book.title}"></a>
				<div class="caption">
				  <h5><c:out value="${book.title}"/></h5>
				  <h4>
					  <a class="defaultBtn" href="product_details.html" title="Click to view"><span class="icon-zoom-in"></span></a>
					  <h4><a class="shopBtn" href="/OnlineBookStore/Cart?title=${book.title}&price=${book.price}&author=${book.author}&bookid=${book.bookid}&image=${book.image}&operation=add" title="add to cart"> Add to cart </a><span class="pull-right">$<c:out value="${book.price}"/></span></h4>
				  </h4>
				</div>
			  </div>
			</li>
